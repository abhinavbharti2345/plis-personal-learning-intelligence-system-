    ...
    <AppLayout>
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-[rgba(255,255,255,0.8)] dark:border-white/10">
        <div>
          ...
          <p className="text-[#4B5563] dark:text-[#E2E8F0] text-sm mt-1 font-medium">Coordinate your topics into actionable daily, weekly, and monthly goals.</p>
        </div>
      </div>
          ...
          <button
            ...
            className={`px-5 py-2 font-bold text-sm tracking-wide rounded-full capitalize transition-colors ${
              activeTab === tab
                ...
                : 'text-[#4B5563] dark:text-[#E2E8F0] hover:bg-[rgba(255,255,255,0.8)] dark:hover:bg-surface-800'
            }`}
          >
            {tab}
          </button>
